...
namespace LinkStorage.Migrations
{
    ...
    [Migration("20240315071636_NowThereIsCouctForPostAndFolloers")]
    partial class NowThereIsCouctForPostAndFolloers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinkStorage.Models.Follows", b =>
                {
            ...
            modelBuilder.Entity("LinkStorage.Models.User", b =>
                {
                    ...
                    b.Property<long>("FollowingsCount")
                        .HasColumnType("bigint");

                    b.Property<long>("PublicPostCount")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LinkStorage.Models.Follows", b =>
                {
                    b.HasOne("LinkStorage.Models.User", "Followers")
                        .WithMany("Following")
                        .HasForeignKey("Follower_Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LinkStorage.Models.User", "Following")
                        .WithMany("Followers")
